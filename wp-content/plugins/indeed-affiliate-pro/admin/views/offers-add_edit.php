<div class="uap-wrapper">
	...
	<div class="inside">
		<div class="uap-inside-item">
				<div class="row">
					<div class="col-xs-6">
					<h4><?php esc_html_e('Activate/Hold Offer', 'uap');?></h4>
			...
			<div class="uap-inside-item">
					<div class="row">
						<div class="col-xs-4">
							<h3><?php esc_html_e('Offer Amount', 'uap');?></h3>
				...
				<div class="uap-inside-item">
					<div class="row">
						<div class="col-xs-4">
							<h3><?php esc_html_e('Date Range', 'uap');?></h3>
				...
				<div class="uap-inside-item uap-special-line">
					<div class="row">
						<div class="col-xs-4">
							<h3><?php esc_html_e('Targeting', 'uap');?></h3>
				...
				<div class="uap-inside-item">
					<div class="row">
						<div class="col-xs-4">
							<h3><?php esc_html_e('Offer Color', 'uap');?></h3>
							<div>
