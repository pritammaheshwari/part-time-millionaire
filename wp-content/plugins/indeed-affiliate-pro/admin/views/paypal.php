	...
	<div class="uap-stuffbox">
		...
		<div class="inside">
			<?php if ((float)$phpversion>=5.4):?>
				<div class="row">
						<div class="col-xs-7">
							<h3><?php  esc_html_e('Activate/Hold PayPal Gateway', 'uap');?></h3>
					...
					<div class="col-xs-6">
						<div class="uap-js-paypal-sandbox-credentials  <?php echo ( !$data['metas']['uap_paypal_sandbox'] ) ? "uap-display-none" : '';?> ">
								<div class="uap-form-line">
									<label class="uap-label"><?php  esc_html_e('Sandbox Client ID', 'uap');?></label>
									<input type="text" name="uap_paypal_sandbox_client_id" value="<?php echo $data['metas']['uap_paypal_sandbox_client_id'];?>" />
								</div>
								<div class="uap-form-line">
									<label class="uap-label"><?php  esc_html_e('Sandbox Client Secret', 'uap');?></label>
						...
						<div class="uap-js-paypal-live-credentials <?php echo ( $data['metas']['uap_paypal_sandbox'] ) ? "uap-display-none" : '';?>"  >
								<div class="uap-form-line">
									<label class="uap-label"><?php  esc_html_e('Client ID', 'uap');?></label>
									<input type="text" name="uap_paypal_client_id" value="<?php echo $data['metas']['uap_paypal_client_id'];?>" />
								</div>
								<div class="uap-form-line">
									<label class="uap-label"><?php  esc_html_e('Client Secret', 'uap');?></label>
