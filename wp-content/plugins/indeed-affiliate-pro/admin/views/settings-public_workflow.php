		...
		<div class="inside">
			...
			<div class="uap-inside-item">
				<div class="row">
					...
					<div class="col-xs-12">
						<h3><?php esc_html_e('Hide Payment Warnings', 'uap');?></h3>
					...
					<div class="col-xs-12">
						<h3><?php esc_html_e('Default Payment System', 'uap');?></h3>
					...
					<div class="col-xs-12">
						<h3><?php esc_html_e('Disable Bank Transfer', 'uap');?></h3>
					...
					<div class="col-xs-12">
						<h3><?php esc_html_e('Sources custom names', 'uap');?></h3>
						<?php
								$types = [
