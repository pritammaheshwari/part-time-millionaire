	...
	<div class="uap-additional-help">
		<div class="uap-footer-text"><strong>Ultimate Affiliate Pro v. <?php echo $plugin_vs; ?></strong> Wordpress Plugin by <a href="https://codecanyon.net/user/azzaroco/portfolio?ref=azzaroco" target="_blank">azzaroco</a></div>
            ...
            <a href="https://www.youtube.com/playlist?list=PLmOiaKgLhsFl0M5nbPeLP1J6PbLvBkmeH" target="_blank" title="Video Tutorials" class="button float_right uap-red-button"><i class="fa fa-book"></i> Video Tutorials</a>
             <a href="https://store.wpindeed.com/addon/category/ultimate-affiliate-pro/" target="_blank" title="Video Tutorials" class="button float_right uap-blue-button"><i class="fa fa-book"></i> Extra AddOns</a>
