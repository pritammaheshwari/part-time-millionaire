<form  method="post">
	<div class="uap-stuffbox">
		...
		<div class="inside">
			<div class="row">
				<div class="col-xs-8">
					<h3><?php esc_html_e('Activate/Hold  Checkout Reward', 'uap');?></h3>
			...
			<div class="row">
				<div class="col-xs-5">
					<h3><?php esc_html_e('Form Label field', 'uap');?></h3>
			...
			<div class="row">
				<div class="col-xs-4">
					<h3><?php esc_html_e('Field Settings', 'uap');?></h3>
			...
			<div class="row">
				<div class="col-xs-5">
				<h3><?php esc_html_e('Additional Settings', 'uap');?></h3>
					<div class="uap-form-line">
