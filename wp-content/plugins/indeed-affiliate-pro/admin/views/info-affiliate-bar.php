		...
		<form  method="post">
			<div class="uap-stuffbox">
				...
				<div class="row">
					...
					<div class="row">
					<div class="col-xs-6">
                    <h3><?php esc_html_e('FlashBar Logo', 'uap');?></h3>
					...
					<div class="row">
					<div class="col-xs-4">
							<h3><?php esc_html_e( 'Links Section', 'uap' );?></h3>
					...
					<div class="row">
					<div class="col-xs-4">
							<h3><?php esc_html_e( 'Banner Section', 'uap' );?></h3>
					...
					<div class="row">
					<div class="col-xs-4">
							<h3><?php esc_html_e( 'Social Section', 'uap' );?></h3>
							...
							<div>
									<h3><?php esc_html_e( 'Shortcode', 'uap' );?></h3>
					...
					<div class="row">
					<div class="col-xs-5">
							<h3><?php esc_html_e( 'Stats Section', 'uap' );?></h3>
							...
							<h4><?php esc_html_e( 'General Stats', 'uap' );?></h4>
					...
					<div class="row">
					<div class="col-xs-4">
							<h3><?php esc_html_e( 'Menu Section', 'uap' );?></h3>
							<label class="uap_label_shiwtch uap-switch-button-margin">
