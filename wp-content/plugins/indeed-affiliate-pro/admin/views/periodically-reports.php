<form  method="post">
	<div class="uap-stuffbox">
		...
		<div class="inside">
			...
			<div class="row">
				<div class="col-xs-7">
					<h3><?php esc_html_e('Activate/Hold Periodic Reports', 'uap');?></h3>
			...
			<div class="row">
				<div class="col-xs-6">
					<h3><?php esc_html_e('Report Subject', 'uap');?></h3>
			...
			<div class="row">
				<div class="col-xs-12">
					<h3><?php esc_html_e('Report Content', 'uap');?></h3>
			...
			<div class="row">
				<div class="col-xs-8">
					<h3><?php esc_html_e('Send Notification Time', 'uap');?></h3>
