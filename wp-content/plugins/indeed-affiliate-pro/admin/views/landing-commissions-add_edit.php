<div class="uap-wrapper">
	...
	<div class="inside">
		<div class="uap-inside-item">
			<div class="row">
				<div class="col-xs-6">
				<h4><?php esc_html_e( 'Activate/Hold (CPA) Shortcode', 'uap');?></h4>
		...
		<div class="uap-inside-item">
			<div class="row">
				<div class="col-xs-6">
					<h3><?php echo esc_html__('Commission Price', 'uap');?></h3>
			...
			<div class="row">
				<div class="col-xs-4">
					<h3><?php esc_html_e( 'Referral Default Status', 'uap');?></h3>
					<div>
		...
		<div class="uap-inside-item">
			...
			<div class="row">
				<div class="col-xs-6">
					<h3><?php echo esc_html__('Cookie Expire Time', 'uap');?></h3>
		...
		<div class="uap-line-break"></div>
				<div class="uap-inside-item">
					<div class="row">
						<div class="col-xs-4">
							<h3><?php esc_html_e( 'Color', 'uap');?></h3>
							<div>
