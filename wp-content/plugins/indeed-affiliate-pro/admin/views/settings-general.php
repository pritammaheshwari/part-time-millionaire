...
<div class="uap-stuffbox">
	...
	<div class="inside">
		<div class="uap-inside-item">
			<div class="row">
				<div class="col-xs-6">
					<h3><?php esc_html_e('Which Amount should be used for Referral?', 'uap');?></h3>
		...
		<div class="uap-inside-item">
			<div class="row">
				<div class="col-xs-6">
					<h3><?php esc_html_e('Redirect', 'uap');?></h3>
		...
		<div class="uap-inside-item">
			<div class="row">
				<div class="col-xs-4">
				<h3><?php esc_html_e('Referral Settings', 'uap');?></h3>
				<br/>
				<p><?php esc_html_e('Set the referral Variable name', 'uap');?></p>
			...
			<div class="row">
				<div class="col-xs-4">
				<h3><?php esc_html_e('Base Referral Link', 'uap');?></h3>
				<br/>
					<div class="form-group">
...
Do not enter a link from a different website.', 'uap');?></p>
		...
		<div class="uap-inside-item">
			<div class="row">
				<div class="col-xs-4">
				<p class="uap-labels-special"><?php esc_html_e('Referral Format:', 'uap');?></p>
		...
		<div class="uap-inside-item">
			<div class="row">
				<div class="col-xs-4">
						<p class="uap-labels-special"><?php esc_html_e('Search into URL for both referral format:', 'uap');?></p>
						<label class="uap_label_shiwtch uap-switch-button-margin">
	...
	<div class="uap-inside-item">
		<div class="row">
			<div class="col-xs-4">
			<h3><?php esc_html_e('Referral URL Blacklist', 'uap');?></h3>
			<br/>
		...
		<div class="uap-inside-item">
			<div class="row">
				<div class="col-xs-4">
				<h3><?php esc_html_e('Campaign Settings', 'uap');?></h3>
				<br/>
		...
		<div class="uap-inside-item">
			<div class="row">
				<div class="col-xs-4">
					<h3><?php esc_html_e('Amount Value Settings', 'uap');?></h3>
					<div class="uap-form-line">
		...
		<div class="uap-inside-item">
			<div class="row">
				<div class="col-xs-6">
					<h3><?php esc_html_e('Default Country', 'uap');?></h3>
		...
		<div class="uap-inside-item">
			<div class="row">
				<div class="col-xs-6">
					<h3><?php esc_html_e('Automatically Affiliate', 'uap');?></h3>
		...
		<div class="uap-inside-item">
			<div class="row">
				<div class="col-xs-6">
					<h3><?php esc_html_e('Empty Referrals', 'uap');?></h3>
