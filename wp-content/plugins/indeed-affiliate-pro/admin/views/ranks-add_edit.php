			<form action="<?php echo $data['url-manage'];?>" method="post">
				...
				<div class="uap-stuffbox">
					...
					<div class="uap-inside-item">
						<div class="row">
							<div class="col-xs-6">
							<h4><?php esc_html_e('Activate/Hold Rank', 'uap');?></h4>
				...
				<div class="uap-inside-item">
					<div class="row">
						<div class="col-xs-6">
							<h3><?php esc_html_e('Rank Settings', 'uap');?></h3>
				...
				<div class="uap-inside-item">
					<div class="row">
						<div class="col-xs-8">
							<h3><?php esc_html_e('Position', 'uap');?></h3>
				...
				<div class="uap-inside-item">
					<div class="row">
						<div class="col-xs-4">
							<h3><?php esc_html_e('Rank Amount', 'uap');?></h3>
...
?>
				...
				<div class="uap-inside-item">
					<div class="row">
						<div class="col-xs-12">
							<h3><?php esc_html_e('Achievement', 'uap');?></h3>
				...
				<div class="uap-inside-item">
					<div class="row">
						<div class="col-xs-4">
							<h3><?php esc_html_e('Rank Color', 'uap');?></h3>
							<div>
		...
		<div class="uap-stuffbox uap-magic-stuffbox <?php echo  (empty($data['bonus_enabled'])) ? 'uap-display-none' : 'uap-display-block'; ?>">
			...
			<div class="row">
				<div class="col-xs-4">
					<h3><?php esc_html_e('Achievement Bonus', 'uap');?></h3>
		...
		<div class="uap-stuffbox uap-magic-stuffbox <?php echo ($data['display-signup_referrals']) ? 'uap-display-block' : 'uap-display-none'; ?>">
			...
			<div class="row">
				<div class="col-xs-4">
					<h3><?php esc_html_e('SignUp Referrals', 'uap');?></h3>
		...
		<div class="uap-stuffbox uap-magic-stuffbox <?php echo ($data['display-lifetime_commissions']) ? 'uap-display-block' : 'uap-display-none'; ?>">
			...
			<div class="row">
				<div class="col-xs-4">
					<h3><?php esc_html_e('LifeTime Comission', 'uap');?></h3>
		...
		<div class="uap-stuffbox uap-magic-stuffbox <?php echo ($data['display-reccuring_referrals']) ? 'uap-display-block' : 'uap-display-none'; ?>">
			...
			<div class="row">
				<div class="col-xs-4">
					<h3><?php esc_html_e('Reccurring Referrals', 'uap');?></h3>
		...
		<div class="uap-stuffbox uap-magic-stuffbox <?php echo ($data['display-mlm']) ? 'uap-display-block' : 'uap-display-none'; ?>">
			...
			<div class="row">
				<div class="col-xs-6">
					<h3><?php esc_html_e('MLM Referrals For Each MLM Level', 'uap');?></h3>
        ...
        <div class="uap-stuffbox uap-magic-stuffbox <?php echo  (empty($data['pay_per_click_enabled'])) ? 'uap-display-none' : 'uap-display-block'; ?>">
			...
			<div class="row">
				<div class="col-xs-4">
					<h3><?php esc_html_e('PPC Amount', 'uap');?></h3>
        ...
        <div class="uap-stuffbox uap-magic-stuffbox <?php echo  (empty($data['cpm_commission_enabled'])) ? 'uap-display-none' : 'uap-display-block'; ?>">
			...
			<div class="row">
				<div class="col-xs-4">
					<h3><?php esc_html_e('CPM Amount', 'uap');?></h3>
