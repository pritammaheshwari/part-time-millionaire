...
if (!class_exists('UapMainAdmin')){
	class UapMainAdmin{
		...
		public function uap_manage_ump() {
			...
			$submenu['ultimate_affiliates_pro'][200] = array( 'Ultimate Membership Pro', 'manage_options' , 'https://wpindeed.com/ultimate-membership-pro', 'uap-ihc-link-wrapp', 'uap-ihc-link-wrapp', '_blank' );
		}
